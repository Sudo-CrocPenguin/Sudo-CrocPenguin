...
[![Phone](https://img.shields.io/badge/Tel-321_220_3507-555?style=flat-square)](tel:+573212203507)
...
Desarrollador de Software Junior con base sólida en **infraestructura de sistemas y desarrollo backend**, actualmente en tercer semestre de Tecnología en Desarrollo de Software en la **Universidad Católica Luis Amigó**.
...
![SQL](https://img.shields.io/badge/SQL-MariaDB-003545?style=flat-square&logo=mariadb&logoColor=white)

### 📱 Frontend & Mobile
![TypeScript](https://img.shields.io/badge/TypeScript-3178C6?style=flat-square&logo=typescript&logoColor=white)
![React Native](https://img.shields.io/badge/React_Native-Expo_Go_·_Expo_Router-20232A?style=flat-square&logo=react&logoColor=61DAFB)
![Android Studio](https://img.shields.io/badge/Android_Studio-3DDC84?style=flat-square&logo=androidstudio&logoColor=white)
![Xcode](https://img.shields.io/badge/Xcode-147EFB?style=flat-square&logo=xcode&logoColor=white)

### 🔐 Seguridad & Datos
![JWT](https://img.shields.io/badge/JWT-000000?style=flat-square&logo=jsonwebtokens&logoColor=white)
![Argon2](https://img.shields.io/badge/Argon2-·-555?style=flat-square)
![AES-256](https://img.shields.io/badge/AES--256-·-555?style=flat-square)
...
![SSL](https://img.shields.io/badge/SSL/TLS-Certs-0f3460?style=flat-square)
...
Sistema integral personal de finanzas y agenda con arquitectura **DDD**.
- **Backend:** Java · Spring Boot · MariaDB · Flyway · APIs REST
- **Mobile:** React Native (Expo) con Expo Router
- **Seguridad:** JWT + SecureStore · cifrado en dispositivo
- **Arquitectura:** Diseño Orientado al Dominio con DTOs entre capas

---

### 🖥️ Infraestructura Self-Hosted
...
```
[Mar. 2026 – Presente] Desarrollador Web Freelance & Admin de Sistemas
  ├── Servidor Ubuntu propio en producción (web + backends activos)
  ├── Hardening SSH: puertos, llaves públicas, restricción por IP
  ├── Automatización de mantenimiento y monitoreo via scripting
  └── Backends Spring Boot + MariaDB con APIs REST documentadas
```
...
## `$ cat objetivos_2026.md`

- [ ] Consolidar perfil como desarrollador backend con Java y Spring
- [ ] Obtener práctica profesional como Desarrollador Junior
- [ ] Implementar CI/CD con GitHub Actions en proyectos propios
- [ ] Escalar infraestructura y servicios self-hosted
- [ ] Desarrollar soluciones automatizadas para cliente final

---

<div align="center">

**¿Hablamos?** → `miguel.blandonmo@amigo.edu.co` · `321 220 3507`
